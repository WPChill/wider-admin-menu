...
<p><?php printf( esc_html__( 'For WordPress %s, substitute %s.', 'wider-admin-menu'), '4', '<code>wider-admin-menu-40.css</code>' ); ?></p>
<p><?php printf( esc_html__( 'For WordPress %s to %s, substitute %s.', 'wider-admin-menu'), '3.8', '3.9.2', '<code>wider-admin-menu-38.css</code>' ); ?></p>
<p><?php printf( esc_html__( 'For WordPress %s to %s, substitute %s.', 'wider-admin-menu'), '3.5', '3.7.1', '<code>wider-admin-menu-35.css</code>' ); ?></p>
<p><?php printf( esc_html__( 'For WordPress %s to %s, substitute %s.', 'wider-admin-menu'), '3.3', '3.4.2', '<code>wider-admin-menu-33.css</code>' ); ?></p>
