...
<p><strong><?php _e( 'That stylesheet covers WordPress version 5.', 'wider-admin-menu' ); ?></strong></p>
<p><?php printf( __( 'For WordPress %s, substitute %s.', 'wider-admin-menu'), '4', '<code>wider-admin-menu-40.css</code>' ); ?></p>
